...
<div class="article-wrapper w-100 margin-top-50 margin-bottom-50" style="background-image: url('<?php echo $featuredImg[0]; ?>'); background-repeat: no-repeat; background-size: cover; background-position:center;">
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<header class="entry-header">
			...
			<div>
				<p class="post-data">
					<span class="post-author">Author<br> <a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" title="<?php echo esc_attr( get_the_author() ); ?>"><?php the_author(); ?></a></span>
				</p>
			</div>
		</header><!-- .entry-header -->
		<div class="excerpt">
